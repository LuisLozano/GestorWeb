...
@Table(name="Cliente", schema = "public", 
		indexes = {@Index(name="CLIENT_DNI_IDX", columnList="dni", unique=true)},
		uniqueConstraints={
...
public class Cliente implements Serializable {
	...
	@NotNull(message="Debe introducir apellidos")
	@Size(max=100, min=4,message="Apellidos demasiado cortos")
	...
	@Size(max=50, min=4,message="El nombre es muy corto")
	...
	@OneToMany(mappedBy="pagador", orphanRemoval=true)
