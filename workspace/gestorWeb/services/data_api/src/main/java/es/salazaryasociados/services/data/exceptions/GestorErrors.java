...
public enum GestorErrors {
	...
	VALIDATE_EXCEPTION("Error de validación"),
	...
	FILE_HAS_NO_CLIENTS("El expediente no tiene clientes"),
	...
	CLIENT_HAS_FILES("No puede eliminar un cliente con expedientes asociados"),
	...
	ADD_CLIENT_TO_EXP_CLIENT_NOT_FOUND("A�adir cliente: No se encuentra el cliente"),
