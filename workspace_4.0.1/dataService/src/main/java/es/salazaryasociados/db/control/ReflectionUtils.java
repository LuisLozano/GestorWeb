...
public class ReflectionUtils {
	 ...
	 */
	public static Field getIdField(final Class<?> entityClass)
			throws IllegalArgumentException {
		...
		throw new IllegalArgumentException("No id field found on class "
				+ entityClass);
	}
	 ...
	 * ).
	 */
	public static Object getPropertyValue(final Object object,
	...
	private static String toMethodName(final String methodPrefix,
			final String propertyName) {
		return methodPrefix
	...
	private static Method getGetter(final Class<?> clazz,
		...
		try {
			...
			try {
				...
				throw new RuntimeException("Method '" + clazz.getSimpleName()
						+ '#' + is
			...
			try {
				...
				throw new RuntimeException("Methods '" + clazz.getSimpleName()
						+ '#' + get + "()' and " + clazz.getSimpleName() + '#'
						+ is + "()' are protected by the security manager.");
			}
		}
		return getter;
	}
